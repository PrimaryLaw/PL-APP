        ...
        */}
        ...
        <div className="flex-[4]  border-l-slate-200">
          <div className="flex justify-center">
            <Button 
            className="m-2 w-[27vh] active bg-mainGreen font-semibold leading-normal bg-mainGreen  border  "
            ...
            <Button
              className={`m-2 w-[27vh] bg-defaultWhite text-slate-700 border border-slate-700 opacity-50" : "bg-mainGreen"
              }`}
              id="insights-comp"
